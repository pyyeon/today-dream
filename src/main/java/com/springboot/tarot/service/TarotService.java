...
//                "(22, 'The World', '완성, 성취, 통합')" +
                ...
                "그 세 장 카드에 대한 해석은 category에 따라 result에 담아서 주는데,  " +
                "먼저, 나온 카드를 차례로 무슨 카드가 나왔는지 말해줘. " +
                "두괄식으로 전체 내용을 요약한 한 문장으로 시작하고 나머지 문장은 한 줄 띄고 다음 문장부터 작성해줘. " +
                "구체적이고 현실적이어야 해. 안 좋은 일이라도 그대로 솔직히 말해도 돼. 직관적으로 말해줘." +
